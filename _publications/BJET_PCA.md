...
permalink: /BJET_PCA_2022
excerpt: 'This exploratory article highlights how problem-based learning (PBL) provided the pedagogical framework used to design and interpret learning analytics from CRYSTAL ISLAND: ECOJOURNEYS, a collaborative game-based learning environment centered on supporting science inquiry.'
date: 2022-04-01
venue: 'British Journal of Educational Technology'
citation: 'Saleh, A., Phillips, T., Hmelo-Silver, C., Glazewski, K., Mott, B., Lester., J. (2022). &quot;A learning analytics approach towards understanding collaborative inquiry in a problem-based learning environment.&quot; <i>British Journal of Educational Technology</i>.'
---
